...
class WeightedMolTreeFolder(MolTreeFolder):
    ...
    def _set_data_properties(self, property_dict):
        ...
        #     ):
        #         # TODO: Properly map the values from the original dataset
        #         property_dict[s] = np.mean(list(property_dict.values()))
        #         # print((s, property_dict[s]))
        ...
        self.data_properties = list(property_dict.values())     # Assuming they stay in same order

        print(self.smiles[:10])
        print(self.canonic_smiles[:10])
        print(list(property_dict.keys())[:10])
        print(self.data_properties[:10])
        print(self.canonic_smiles[-10:])
        print(list(property_dict.keys())[-10:])
        print(self.data_properties[-10:])
        # print(data)
        ...
        # self.weights = self.data_weighter.weighting_function(np.ones(len(self.data)))
